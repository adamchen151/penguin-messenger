            ...
            <div className="space-y-12">
                <div className="border-b border-gray-900/10 pb-12">
                    ...
                    <div className="mt-10 flex flex-col gap-y-8">
                        ...
                        <label className="blcok text-sm font-medium leading-6 text-gray-900">
                            Photo
                        </label>
                        <div className="mt-2 flex items-center gap-x-3">
                            <Image width='48' height='48' className="rounded-full"
                                src={image || currentUser?.image || "/images/placeholder.jpg"} alt="Avatar"
                            />
                            <CldUploadButton options={{ maxFiles: 1 }} onUpload={handleUpload} uploadPreset="k0o96g9i">
